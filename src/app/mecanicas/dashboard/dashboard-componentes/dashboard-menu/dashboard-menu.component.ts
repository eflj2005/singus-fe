    ...
    switch( this.autenticador.UsuarioActualValor.rol ){
      case "D":
        ...
        this.menu  = [ 
          ...
          { opcion: 'M0 - Pregrado'       , url: '/cargues'               , parametros: '5'   ,  icon: "fa-files-o"                 , agrupamiento: "Cargue Masivo"     ,iconPrincipal:"fa-wpforms"            , orden: 1  },
          { opcion: 'M0 - Postgrado'      , url: '/cargues'               , parametros: '6'   ,  icon: "fa-files-o"                 , agrupamiento: "Cargue Masivo"     ,iconPrincipal:"fa-wpforms"            , orden: 1  },          
          ...
          { opcion: 'Personalizados'      , url: '/personalizados'        , parametros: null  ,  icon: "fa-file-code-o"             , agrupamiento: "Reportes"          ,iconPrincipal:"fa-file-text-o"        , orden: 4  },
