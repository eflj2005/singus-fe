...
this.usuario = "Juan Bustos";
  ...
  this.menu  = [ 
    ...
    { opcion: 'Perzonalizados'    , url: '/personalizados'           , icon: "fa-file-code-o"             , agrupamiento: "Reportes"          ,iconPrincipal:"fa-file-text-o"        , orden: 4  },
    ...
    { opcion: 'Auditoria'         , url: '/auditoria'             , icon: "fa-bar-chart "              , agrupamiento: "Administración"    ,iconPrincipal:"fa-user-circle-o"      , orden: 5  },
  ];
